...
(defn frequency
  ...
  generators with the highest likelihood and earlier generators among
  equal likelihoods, as well as shrinking the value generated by the
  chosen generator.
  ...
  (core/let [pairs (sort (comparator (fn [a b] (> (first a) (first b)))) pairs)
